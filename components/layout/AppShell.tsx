        ...
        <header className="sticky top-0 z-20 border-b bg-[rgb(7_16_24/92%)] backdrop-blur">
          <div className="flex min-h-16 items-center gap-3 px-4 md:px-6">
            ...
            <div className="ml-auto flex items-center gap-2 sm:gap-3">
              <div
                className="text-muted hidden items-center gap-1.5 text-xs md:flex"
                title="Realtime communication is planned for Sprint 4"
              >
                <span className="size-2 rounded-full bg-[var(--status-unknown)]" />
                Realtime planned
              </div>
              <DemoDataBadge />
            </div>
